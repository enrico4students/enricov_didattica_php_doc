...
/ is the delimiter, 
w3schools is the pattern that is being searched for, and 
...
The most common delimiter is the forward slash (/), but when your pattern contains forward slashes 
it is convenient to choose other delimiters such as # or ~.
*/
...
// Use a regular expression to do a case-insensitive search for "w3schools" in a string:
    ...
    $str = "Visit W3Schools";
    $pattern = "/w3schools/i";
    echo preg_match($pattern, $str); nl();
...
$pattern = "/ain/i";
echo preg_match_all($pattern, $str); nl();
...
$str = "Visit Microsoft!";
$pattern = "/microsoft/i";
echo preg_replace($pattern, "W3Schools", $str); nl();
